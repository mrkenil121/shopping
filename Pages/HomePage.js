  ...
  return (
    <div className="container min-w-full px-4 py-8 bg-gradient-to-b from-gray-800 via-gray-500 to-gray-100 min-h-screen flex flex-col">
      ...
      <div className="flex flex-col md:flex-row gap-12 w-full justify-between">
        <div className="md:w-1/2 lg:w-1/3 flex flex-col items-start justify-center space-y-6 ml-28">
          <p className="text-2xl font-extrabold text-gray-300 font-sans tracking-wide leading-relaxed">
            Discover amazing deals and transform your shopping experience with
            Us.
          </p>
          {!localStorage.getItem("user") && (
            <Button
              className="w-full md:w-auto text-lg py-6 bg-transparent text-white border border-white/20 hover:shadow-lg hover:shadow-white/10 transition-all duration-300 hover:bg-white/5"
      ...
      <div className="mb-12">
      <h2 className="text-3xl font-bold pb-2 border-b-2 border-gray-800 inline-block">
